    ...
    <div class="container is-widescreen has-text-left">
      <section class="section">
        <div class="content">
          ...
          <p class="texte">
            Votre spécialiste en électricité Novelec met en conformité votre installation électrique, effectue vos
            travaux d’appareillage (interrupteurs, prises, etc...), et s’occupe de la distribution du réseau électrique
            dans chacune de vos pièces. Novelec vous propose un accompagnement sur mesure tout au long de votre projet
